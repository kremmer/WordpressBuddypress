...
/*
  Controller name: BuddypressCUD
  Controller description: Buddypress controller for create/update/delete actions
 */

require_once JSON_CUD_API_FOR_BUDDYPRESS_HOME . '/library/functions.class.php';

class JSON_API_BuddypressCUD_Controller {
    ...
    public function activity_create_activity() {
