...
class JSON_CUD_API_FOR_BUDDYPRESS_FUNCTION extends JSON_API_BuddypressCUD_Controller {
    ...
    protected static function init($sModule) {
        ...
        require_once (JSON_CUD_API_FOR_BUDDYPRESS_HOME . '/library/parameters.php');
    ...
    protected static function error($sModule, $iCode = "") {
        ...
        switch ($sModule) {
            case "activity":
                $oReturn->msg = __('No Activities found.', 'json-CUD-api-for-buddypress');
                break;
            case "xprofile":
                switch ($iCode) {
                    case 0:
                        $oReturn->msg = __('No Profile found.', 'json-CUD-api-for-buddypress');
                        break;
                    case 1:
                        $oReturn->msg = __('Username not found.', 'json-CUD-api-for-buddypress');
                        break;
                }
                break;
            case "messages":
                $oReturn->msg = __('No messages found.', 'json-CUD-api-for-buddypress');
                break;
            case "notifications":
                $oReturn->msg = __('No notifications found.', 'json-CUD-api-for-buddypress');
                break;
            case "friends":
                switch ($iCode) {
                    case 0:
                        ...
                        break;
                    case 1:
                        $oReturn->msg = __('No friends found.', 'json-CUD-api-for-buddypress');
                        break;
                    case 2:
                        $oReturn->msg = __('No friendship requests found.', 'json-CUD-api-for-buddypress');
                        break;
                    case 3:
                        $oReturn->msg = __('Friendname not found.', 'json-CUD-api-for-buddypress');
                        break;
                }
                break;
            case "groups":
                switch ($iCode) {
                    case 0:
                        $oReturn->msg = __('No groups found.', 'json-CUD-api-for-buddypress');
                        break;
                    case 1:
                        $oReturn->msg = __('Username not found.', 'json-CUD-api-for-buddypress');
                        break;
                    case 2:
                        $oReturn->msg = __('Neither groupid nor groupslug are set.', 'json-CUD-api-for-buddypress');
                        break;
                    case 3:
                        $oReturn->msg = __('Group not found.', 'json-CUD-api-for-buddypress');
                        break;
                    case 4:
                        $oReturn->msg = __('No Members in Group', 'json-CUD-api-for-buddypress');
                        break;
                }
                break;
            case "forums":
                switch ($iCode) {
                    case 0:
                        $oReturn->msg = __('Forums are disabled for this group.', 'json-CUD-api-for-buddypress');
                        break;
                    case 1:
                        $oReturn->msg = __('No forum assigned to this group.', 'json-CUD-api-for-buddypress');
                        break;
                    case 2:
                        $oReturn->msg = __('Neither groupid nor groupslug are set.', 'json-CUD-api-for-buddypress');
                        break;
                    case 3:
                        ...
                        break;
                    case 4:
                        $oReturn->msg = __('Neither forumid nor forumslug are set.', 'json-CUD-api-for-buddypress');
                        break;
                    case 5:
                        $oReturn->msg = __('Forum not found.', 'json-CUD-api-for-buddypress');
                        break;
                    case 6:
                        $oReturn->msg = __('Neither topicid nor topicslug are set.', 'json-CUD-api-for-buddypress');
                        break;
                    case 7:
                        $oReturn->msg = __('No topics in this forum.', 'json-CUD-api-for-buddypress');
                        break;
                    case 8:
                        $oReturn->msg = __('No topics found.', 'json-CUD-api-for-buddypress');
                        break;
                    case 9:
                        $oReturn->msg = __('No forums found.', 'json-CUD-api-for-buddypress');
                        break;
                }
                break;
            case "settings":
            ...
            case "base":
                switch ($iCode) {
                    case 0:
                        $oReturn->msg = __('You are not allowed to view this information.', 'json-CUD-api-for-buddypress');
                        break;
                }
                break;
            default:
                $oReturn->msg = __('An undefined error occured.', 'json-CUD-api-for-buddypress');
        }
        return $oReturn;
    }
